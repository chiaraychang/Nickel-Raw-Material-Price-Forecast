...
from dataload import keyword_list, price_list, target_list
...
class LSTM_price(nn.Module):
    ...
    def __init__(self, hidden_size = 56 , predict_size = 22):
        super(LSTM_price, self).__init__()
        self.price_encoder = lstm_encoder(45, 30, 30).to(device)
        self.key_encoder = lstm_encoder(38, 26, 31).to(device)
        self.price_input = 30
        self.key_input = 26
        self.T = 30
        self.hidden_size = hidden_size
...
if __name__ == "__main__":
    ...
    resume = 'price_predict2_our_series_20000.pth'
